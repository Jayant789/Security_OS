...
function Suspects() {
  ...
  return (
    <>
      <List sx={{ width: '100%', bgcolor: 'background.paper' }}>
        {suspects.map((suspect) => (
          <React.Fragment key={suspect.id}>
            ...
            {suspects.indexOf(suspect) < suspects.length - 1 && (
      ...
      <Dialog open={isDialogOpen} onClose={handleCloseDialog} PaperProps={{ style: { background: 'rgba(128, 128, 128, 0.7)', borderRadius: '8px', padding: '16px' } }}>
