    ...
    <div>
      ...
      <div>
        ...
        <div style={{ display: 'flex', width: '100%', justifyContent: 'space-between' }}>
          <p>
            <img src={require('./violentCrime3.png')} height="30px" width="30px" alt="violent crime icon" /> Violent Crime
          </p>
          <p>
            <img src={require('./propertyCrime3.png')} height="30px" width="30px" alt="property crime icon" /> Property Crime
          </p>
          <p>
            <img src={require('./personalCrime3.png')} height="30px" width="30px" alt="personal crime icon" /> Personal Crime
          </p>
          <p>
